...
const envSchema = z.object({
  ...
  FEATURE_KB_MEMORY_GRAPH: z.coerce.boolean().default(true),
  FEATURE_KB_MEMORY_QUERY_REWRITE: z.coerce.boolean().default(true),
  FEATURE_KB_MEMORY_RELATION_EXPANSION: z.coerce.boolean().default(true),
  FEATURE_KB_MEMORY_PROFILES: z.coerce.boolean().default(true),
