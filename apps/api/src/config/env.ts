...
const envSchema = z.object({
  ...
  AI_AGENT_PROVIDER: z.enum(["openclaw", "hermes"]).default("openclaw"),
  HERMES_RUNTIME_MODE: z.enum(["bridge", "native"]).default("bridge"),
  ...
  HERMES_LLM_API_BASE: z.string().default("https://relay.ones.pro/v1"),
  HERMES_LLM_API_KEY: z.string().optional(),
  HERMES_LLM_MODEL: z.string().default("kimi-k2.6"),
